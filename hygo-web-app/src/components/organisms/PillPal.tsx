  ...
  return (
    <div className="min-h-screen bg-blue-50">
        ...
        {loading ? (
          ...
          return filteredMedications.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <Button onClick={onAddButtonPress} variant="primary">
                Add Medication
              </Button>
            </div>
          ) : (
                ...
                >
                  ...
                  {nextTime && (
                    <div className="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                      <div className="flex items-center">
                        <Icon name="clock" size="small" color="#1e40af" className="mr-2" />
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-blue-800 hover:bg-blue-900 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center z-50"
      >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-6 w-full max-w-sm">
            <div className="text-center mb-6">
              <Icon name="bell" size="large" color="#1e40af" className="mx-auto mb-4" />
