...
const Icon: React.FC<IconProps> = ({
  ...
  const icons = {
    ...
    pills: (
      <svg className={iconClasses} fill="none" viewBox="0 0 24 24">
        ...
        <g transform="rotate(-25 8 12)">
          <rect x="4" y="6" width="8" height="12" rx="4" ry="4" fill={color} stroke="none"/>
          <rect x="4" y="6" width="8" height="6" rx="4" ry="4" fill="white" stroke="none"/>
        </g>

        {/* Big Round Tablet - Simple and clear */}
        <circle cx="17" cy="8" r="5" fill={color} stroke="none"/>
    ...
    star: (
      <svg className={iconClasses} fill={color} stroke="none" viewBox="0 0 24 24">
