...
import { Search, Filter, MapPin, Star, Clock, Users, X, ChevronDown, Stethoscope, Building2, ArrowLeft, RefreshCw, AlertCircle } from 'lucide-react';
...
const DoctorsListUI: React.FC<DoctorsListUIProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-br from-[#0E3293] via-[#1e40af] to-[#3b82f6] text-white">
        <div className="px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold">Find Your Doctor</h1>
                <p className="text-blue-100 mt-1">
                  {displayDoctors.length} expert doctors available
                </p>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-green-300">{availableDoctors}</div>
          ...
          <div className="relative max-w-2xl">
            <div className="flex items-center bg-white/95 backdrop-blur-sm rounded-2xl px-4 py-3 shadow-lg">
              <Search className="w-5 h-5 text-[#0E3293] mr-3" />
              <input
                type="text"
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-2xl p-4">
            <div className="flex items-center">
              ...
              <div>
                <div className="text-emerald-800 font-semibold">Your Location</div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            <div className="bg-gradient-to-r from-[#0E3293]/5 to-blue-50 px-6 py-4 border-b border-gray-100">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <Filter className="w-5 h-5 text-[#0E3293] mr-2" />
                  ...
                  <div className="flex flex-wrap gap-2">
                    {activeFilter !== "All" && (
                      <div className="bg-blue-100 px-3 py-1 rounded-lg flex items-center">
                        <span className="text-sm text-blue-800">Specialty: {activeFilter}</span>
                        <button
                    ...
                    {activeClinicFilter !== "All" && (
                      <div className="bg-emerald-100 px-3 py-1 rounded-lg flex items-center">
                        <span className="text-sm text-emerald-800">Clinic: {activeClinicFilter}</span>
                        <button
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className="w-10 h-10 bg-[#0E3293]/10 rounded-xl flex items-center justify-center mr-3">
                  <Stethoscope className="w-5 h-5 text-[#0E3293]" />
                </div>
                <div>
        ...
        {loading && !refreshing ? (
          ...
          <div className="flex justify-center items-center py-20">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Unable to load doctors</h3>
