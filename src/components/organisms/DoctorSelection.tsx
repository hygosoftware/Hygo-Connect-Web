...
const DoctorSelection: React.FC = () => {
  ...
  const handleDoctorSelect = (doctor: Doctor) => {
    selectDoctor(doctor);
    // Always go to clinic selection after selecting a doctor
    // In doctor flow: show clinics where this doctor is available
    // In clinic flow: this shouldn't happen as doctor selection comes after clinic
    setStep('clinic');
  };
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6">
          ...
          <Typography variant="body1" className="text-gray-600">
            Choose from our experienced doctors
          </Typography>
        </div>
